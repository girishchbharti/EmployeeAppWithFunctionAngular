...
myapp.controller('MyController2', ['$scope',"$filter",function($scope, $filter) {
	...
	$scope.list = [ {
			...
			$scope.Sort = function(fieldName) {
				$scope.order = fieldName;
				$scope.list = $filter('orderBy')($scope.list, $scope.order, $scope.reverse)
